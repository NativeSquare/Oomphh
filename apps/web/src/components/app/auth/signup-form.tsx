  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <FieldDescription className="px-6 text-center">
        By clicking continue, you agree to our <a href="https://www.oomphh.cz/terms" target="_blank" rel="noopener noreferrer">Terms of Service</a>{" "}
        and <a href="https://www.oomphh.cz/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>.
      </FieldDescription>
    </div>
  )
}
