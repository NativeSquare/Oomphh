...
export function MessageBubble({
  ...
  if (isLocationMessage) {
    ...
    const staticMapUrl = `https://maps.geoapify.com/v1/staticmap?style=dark-matter&width=600&height=300&center=lonlat:${longitude},${latitude}&zoom=14.5&marker=lonlat:${longitude},${latitude};color:%23E63B2E;size:medium&apiKey=YOUR_API_KEY`;
